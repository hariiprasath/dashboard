...
<?php
    ...
    if(isset($_GET['success']) && empty($_GET['success'])){
        ...
        var_dump($club_data);
            ...
            quiz_post($club_data);
            header('Location: quiz.php?success'); //here i am sending the get variable success to this page
            exit();
...
<?php
 ...
 $result = mysql_query("SELECT * FROM quiz ORDER BY post_id DESC;");
