...
<?php
    ...
    if(isset($_GET['success']) && empty($_GET['success'])){
        ...
        if(empty($_POST) === false && empty($errors) === true){
            ...
            $target_dir = "club_uploads/imprints/";
            ...
            imprints_post($club_data);
            header('Location: imprints.php?success'); //here i am sending the get variable success to this page
            exit();
...
<?php
 ...
 $result = mysql_query("SELECT * FROM imprints ORDER BY post_id DESC;");
