...
<?php
    ...
    if(isset($_GET['success']) && empty($_GET['success'])){
        ...
        if(empty($_POST) === false && empty($errors) === true){
            ...
            mun_post($club_data);
            header('Location: mun.php?success'); //here i am sending the get variable success to this page
            exit();
...
<?php
 ...
 $result = mysql_query("SELECT * FROM mun ORDER BY post_id DESC;");
