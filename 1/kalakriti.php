...
<?php
    ...
    if(isset($_GET['success']) && empty($_GET['success'])){
        ...
        if(empty($_POST) === false && empty($errors) === true){
            ...
            $target_dir = "club_uploads/kalakriti/";
           ...
           var_dump($club_data);
            ...
            kalakriti_post($club_data);
            header('Location: kalakriti.php?success'); //here i am sending the get variable success to this page
            exit();
...
<?php
 ...
 $result = mysql_query("SELECT * FROM kalakriti ORDER BY post_id DESC;");
